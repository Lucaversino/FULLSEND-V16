-- FULLSEND V17.2.4.1
-- Correção do erro PostgreSQL 42P16: cannot drop columns from view.
-- Seguro para rodar mesmo se a tentativa anterior da migration 028 falhou no meio.
...
-- IMPORTANTE:
-- Mantém EXATAMENTE as mesmas colunas e a mesma ordem da view existente.
-- Só altera o filtro WHERE para esconder itens da Minha Garagem dos classificados.
