...
filtered as (
  ...
  cross join params p
  where
    -- VIP e DESTAQUE pertencem exclusivamente ao carrossel promocional.
    -- A grade paginada abaixo mostra somente anúncios normais.
...
-- Os índices da migration 016 permanecem válidos.
-- Esta migration altera somente a função pública de busca/paginação.
