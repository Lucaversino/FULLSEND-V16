...
import { formatEventDate, formatEventTime, slugifyEvent } from '@/lib/events-shared'
export { EVENT_CATEGORIES, formatEventDate, formatEventTime, slugifyEvent } from '@/lib/events-shared'
export type { EventCategory } from '@/lib/events-shared'
