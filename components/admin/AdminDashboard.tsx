...
type AdminUser={is_verified?:boolean;verified_paid?:boolean;verified_override?:boolean|null;id:string;email:string;created_at?:string;name?:string;city?:string;state?:string;whatsapp?:string;badge?:string;role?:string;account_status?:string;avatar_url?:string;last_admin_note?:string;xp_points?:number;reputation_level?:string}
    ...
    <main className="admin-main">
      ...
      {tab==='overview'?<>
        ...
        <section className="admin-panel-grid">
          ...
          <div className="admin-card"><h3><BadgeCheck size={18}/> IDENTIFICAÇÃO DE USUÁRIOS</h3><div className="badge-showcase"><UserBadge badge="admin"/></div><p>Selo ADM reservado à administração. O Verificado pode ser adquirido por R$ 7,99 ou concedido manualmente na aba Usuários.</p></div>
        </section>
